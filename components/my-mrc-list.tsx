  ...
  return (
    <div>
      {props.loading ? (
        ...
        <div>
          <div className="mb-4">Total: {props.data && props.data.length}</div>
          <ul
            role="list"
              ...
              props.data.map((inscription) => {
                if (inscription.data.objectId) {
                  return (
                    ...
                    >
                      <div className="absolute p-3 font-bold">
                        #{String(inscription.data.objectId).slice(2, 10)}
                      </div>
                      ...
                      <div className="flex justify-between p-2">
                        ...
                        <div>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              props.burn(
                                inscription.data.content.fields.tick,
                                inscription.data.objectId
                              )
                            }}
                          >
                            {" "}
      ...
      <div className="flex justify-center mt-5">
        {!props.loading && props.hasNextPage && (
          <Button className="w-24 bg-sky-700" onClick={props.loadMore}>
            Next Page
          </Button>
        )}
      </div>
